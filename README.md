...
- 전수테스트를 위한 테스트케이스 작성 및 전수 테스트
- 버그 수정 및 디테일 점검 및 보완
- 카카오i 승인 완료에 따른 기능 구현
- UCC영상 기획 및 영상 제작
- 인트로 ( 프레임부터 제작한 뒤 영상은 나중에 찍어서 편집 )
- Body ( 생각했던것 구체화 해서 기획을 해볼것 )
>6주차 - 산출물 제출, 프로젝트 완료<br>
>7주차 - 최종발표 및 수료 <br>
<br>
...
#### New 이슈는 이곳에
그룹선택관련 정렬
- 가장 최근에 방문한 순서로 정렬? 아니면 최신글 올라온 순서로 정렬 어떨까?
- 아마... 클라우드 관련은 업데이트 플랜으로 미뤄야 할것같음.
